...
console.log("=== Test 1: Chinese punctuation in code context (should replace) ===");
{
    const code = `const arr = [1\uFF0C2\uFF0C3];`;
    const results = (0, scanner_1.scanContent)(code, "test.js", {
    ...
    const { content } = (0, scanner_1.replaceContent)(code, "test.js", {
        replacePunctuation: true,
        replaceFullwidth: true,
        replaceChineseChars: false,
        contextAware: true,
...
console.log("\n=== Test 3: Mixed context - code punctuation + Chinese string ===");
{
    ...
    console.log("Input:", code);
    console.log("Output:", content);
    console.log("Pass:", content === 'const obj = {name: "\u5F20\u4E09",age: 25};');
}
...
console.log("\n=== Test 8: String segment parsing ===");
{
    ...
    const segments = (0, scanner_1.parseStringSegments)(line);
    console.log("Input:", line);
    console.log("Segments:", JSON.stringify(segments, null, 2));
    const stringSeg = segments.find((s) => s.isString);
